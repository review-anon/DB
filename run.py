...
def get_experiment_environment(**args):
    ...
    logger_dir += "-KLloss-"+str(args["loss_kl_weight"])      # loss information kl
    logger_dir += "-NCEloss-" + str(args["loss_nce_weight"])  # loss information kl
    logger_dir += "-L2loss-" + str(args["loss_l2_weight"])    # loss information kl
